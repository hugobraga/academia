#ifndef TREE_LABELS_DIST_SPANNER_H    // To make sure you don't declare the function more than once by including the header multiple times.
#define TREE_LABELS_DIST_SPANNER_H
...
const int FAKE_TIME_LIMIT =  TIME_LIMIT;
...
#define FOR_EACH_NODE_r for(int i = 0; i < input.nNodes; i++) { Node* r = input.nodes[i]; //Digraph::Node* u = node->nodeRef; int l1 = node->label;
